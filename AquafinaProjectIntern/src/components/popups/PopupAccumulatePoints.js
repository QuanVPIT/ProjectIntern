...
const PopupAccumulatePoints = (props) => {
  ...
  const visibleModalThank = () => {
    dispatch(updateVisibleTwo(false));
    dispatch(updateVisibleOne(true));
  }
  const visibleModalAP = () => {
    dispatch(updateVisibleTwo(false));
    ...
    <Modal animationType='slide'
      ...
      <View style={styles.container}>
        <View style={styles.viewAccept}>
          ...
          <TouchableOpacity style={styles.buttonAccept} onPress={() => visibleModalAP()}>
